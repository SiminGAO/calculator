...
public class Calculator {
	...
	JButton clear_Button = new JButton("Delete");
	...
	Calculator() {
	 //   button0.setMnemonic(KeyEvent.VK_0);// 等效键
	    ...
	    pan.add(button_jian);
	    pan.add(button_dy);
	    pan.setBorder(BorderFactory.createEmptyBorder(8,8,6,6));// pan对象的边距
	    ...
	    frame.setLocation(300, 300); // 主窗口 出现在位置
	    frame.setResizable(true); // 不能调大小
	    frame.getContentPane().setLayout(new BorderLayout()); //border layout style
